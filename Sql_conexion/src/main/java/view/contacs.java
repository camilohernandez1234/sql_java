 ...
 * @author juana
 */
public class contacs extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField3.setText("numero celular");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(contacs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
